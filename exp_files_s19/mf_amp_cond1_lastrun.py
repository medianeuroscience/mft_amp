...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/jtf/projects/inprogress/mf_amp/exp_files_s19/mf_amp_cond1_lastrun.py',
...
for thisLDT_trials_cond2 in LDT_trials_cond2:
    ...
    for thisLDT_prac_1 in LDT_pracs_1:
        ...
        while continueRoutine:
            ...
            if LDT_mask_prac.status == NOT_STARTED and frameN >= ldt_dur:
                # keep track of start time/frame for later
    ...
    for thisLDT_trial_1 in LDT_trials_1:
        ...
        while continueRoutine:
            ...
            if LDT_mask_trial.status == NOT_STARTED and frameN >= ldt_dur:
                # keep track of start time/frame for later
